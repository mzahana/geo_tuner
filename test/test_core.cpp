...
TEST(Aggregate, OneOutlierFailsTheGate)
{
  // No trimming: with 3-5 samples, dropping the one that disagrees is
  // picking the answer you like. The median is reported; the gate decides.
